package com.project.cars.security.jwt.filter;
...
import com.project.cars.security.jwt.config.ServletUtil;
import com.project.cars.security.jwt.model.JwtLoginInput;
...
//        String json = ServletUtil.getJson("token", jwtToken);
        String json = UserDTO.create(user, "Bearer " + jwtToken).toJson();
